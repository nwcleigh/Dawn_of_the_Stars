...
\par \nar \rmsterope~ awoke when a gust of wind brushed past her face.  The gas was dense enough to temporarily obscure her vision.  She could feel the wind against her stellar surface as it rushed past, gently caressing her fiery skin.  All in all, the wind carried enough momentum to startle her out of slumber.$^{\textcolor{blue}{\ref{boxchap2:linI}},\textcolor{green}{{\ref{boxchap2:linII}},\textcolor{blue}{\ref{boxchap2:linII}},\textcolor{green}{\ref{boxchap2:dynI}}}}$
...
\begin{tcolorbox}[sharp corners, colback=blue!30, colframe=blue!80!blue, title=Box \refstepcounter{educhap2}\label{boxchap2:linI}\ref{boxchap2:linI} -- Linear Momentum I$^1$]
\par \textcolor{black} {The momentum $\vec{p}$ an object possesses is defined as the product of the object's mass and its velocity, or:
\begin{equation}
%\begin{center}
\vec{p} = m\vec{v},
%\end{center}
...
\begin{tcolorbox}[sharp corners, colback=green!30, colframe=green!80!blue,title=Box \refstepcounter{educhap2}\label{boxchap2:linII}\ref{boxchap2:linII} -- Linear Momentum II$^2$]
\par \textcolor{black} {MORE DETAILS OF LINEAR MOMENTUM CONSERVATION AND RADIATION PRESSURE. DERIVE THE CONSERVATION RULES.}.  
\end{tcolorbox}

%\leveltwo{
\begin{tcolorbox}[sharp corners, colback=blue!30, colframe=blue!80!blue, title=Box \refstepcounter{educhap2}\label{boxchap2:angI}\ref{boxchap2:angI} -- Angular Momentum I$^3$]
\par \textcolor{black} {Angular momentum is the rotational analog of linear momentum.  The angular momentum $\vec{L}$ an object possesses is defined as the product of the object's mass and its velocity, or:
\begin{equation}
%\begin{center}
...
%\leveltwo{
\begin{tcolorbox}[sharp corners, colback=green!30, colframe=green!80!blue, title=Box \refstepcounter{educhap2}\label{boxchap2:angII}\ref{boxchap2:angII} -- Angular Momentum II$^4$]
\par \textcolor{black} {GO INTO MORE DETAIL ABOUT ANGULAR MOMENTUM CONSERVATION, AND HOW DERIVE THE CONSERVATION RULES.}.  
\end{tcolorbox}

%\levelone{
\begin{tcolorbox}[sharp corners, colback=blue!30, colframe=blue!80!blue, title=Box \refstepcounter{educhap2}\label{boxchap2:massdensity}\ref{boxchap2:massdensity} -- Mass Density$^5$]
...
%\levelone{
\begin{tcolorbox}[sharp corners, colback=blue!30, colframe=blue!80!blue, title=Box \refstepcounter{educhap2}\label{boxchap2:PE}\ref{boxchap2:PE} -- Gravitational Potential Energy$^6$]
...
%\leveltwo{
\begin{tcolorbox}[sharp corners, colback=blue!30, colframe=blue!80!blue, title=Box \refstepcounter{educhap2}\label{boxchap2:KE}\ref{boxchap2:KE} -- Kinetic Energy$^7$]
...
\begin{tcolorbox}[sharp corners, colback=blue!30, colframe=blue!80!blue, title=Box \refstepcounter{educhap2}\label{boxchap2:en}\ref{boxchap2:en} -- Total Energy$^8$]
...
\begin{tcolorbox}[sharp corners, colback=blue!30, colframe=blue!80!blue,title=Box \refstepcounter{educhap2}\label{boxchap2:be}\ref{boxchap2:angbe} -- Gravitational Binding Energy$^9$]
...
\begin{tcolorbox}[sharp corners, colback=green!30, colframe=green!80!blue, title=Box \refstepcounter{educhap2}\label{boxchap2:vt}\ref{boxchap2:vt} -- Virial Theorem$^{10}$]
