...
\par \textcolor{black}{When a system consists of just two bodies, then the bodies orbit within the same two-dimensional plane. Since there is no source of gravitational acceleration in the third dimension, isolated systems that begin coplanar will remain coplanar idenfinitely.}
\end{tcolorbox}
...
\par \textcolor{black}{The part of closest approach of the trajectory of an orbiting body is called ``periapsis'', and corresponds to where along an eccentric orbit the orbital velocity is at a maximum.}.  
\end{tcolorbox}
...
\begin{tcolorbox}[sharp corners, colback=green!30, colframe=green!80!blue, title=Orbital Dynamics IIc (continued)]
...
\begin{tcolorbox}[sharp corners, colback=blue!30, colframe=blue!80!blue,  title=Orbits in hierarchical triples]
...
\begin{tcolorbox}[sharp corners, colback=green!30, colframe=green!80!blue, title=Orbital Dynamics IIIc (continued)]
\par \textcolor{black}{
