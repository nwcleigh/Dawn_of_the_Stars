...
%DISCUSS ORBITAL DYNAMICS, IN THE CONTEXT OF THE TWO-BODY PROBLEM.  DESCRIBE HOW FOR STABLE TRIPLES, TO FIRST ORDER, ONE CAN APPLY THE TWO-BODY PROBLEM TWICE, TAKING THE INNER BINARY AS A SINGLE OBJECT.}.  
\end{tcolorbox}
